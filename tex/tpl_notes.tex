...
\section{Python type checking}
	...
	\subsection{Duck typing}
		...
		\subsubsection{Main idea}
			INSERIRE CHE IL DUCK TYPING è PREROGATIVA DEL DYNAMIC TYPING (FONTE TROVATA E SLIDE 14)
			...
			INSERIRE DEFINIZIONE SLIDE 14 (MAGARI TROVARE LA FONTE ORIGINALE)
			...
			This is a classical example of \textbf{\textit{dependency injection}}.\\
			My class \textbf{MakeItQuack} receives an instance of an \textbf{animal} and use it to do something. Note that my MakeItQuack instances does not depends on any concrete implementation of animal. And I'm not importing any other type! Just using a dependency injected instance of something that responds to a quack message. I could say my class MakeItQuack depends on an interface. But I did not have to declare it. \textbf{It is an automatic interface}!
